...
export async function createService(input: AdminServiceInput) {
  ...
  revalidatePath("/[lang]/dashboard-admin/servicios", "page");
...
export async function setRequestStatus(id: string, status: string) {
  ...
  revalidatePath("/[lang]/dashboard-admin/solicitudes", "page");
  return { success: true };
}
...
export async function toggleMatchingRule(id: string, status: string) {
  ...
  revalidatePath("/[lang]/dashboard-admin/matching", "page");
  return { success: true };
}
...
export async function setReviewStatus(id: string, status: string) {
  ...
  revalidatePath("/[lang]/dashboard-admin/resenas", "page");
  return { success: true };
}
...
export async function setJobStatus(id: string, status: string) {
  ...
  revalidatePath("/[lang]/dashboard-admin/trabajos", "page");
  return { success: true };
}
...
export async function setTicketStatus(id: string, status: string) {
  ...
  revalidatePath("/[lang]/dashboard-admin/soporte", "page");
  return { success: true };
}
...
export async function setClientBlocked(id: string) {
  ...
  revalidatePath("/[lang]/dashboard-admin/clientes", "page");
  return { success: true };
}
